Repositório do grupo de estudos sobre react do [Training Center](https://training-center.github.io).
...
Este grupo se destina ao estudo de react.
...
Basta responder [este formulário]() para sabermos seu nível de conhecimento, entrar no [Slack do Training Center](https://github.com/training-center/slack) e entrar no canal **#react-studies**.
